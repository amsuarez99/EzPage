import { NonVoidType } from './types'
type Operator = '+' | '-' | '*' | '/' | '<' | '>' | '<=' | '>=' | '==' | '!=' | '&&' | '||'
type TypeError = 'Type Error'

type SemanticCube = Record<Operator, OperatorRecord>
type OperatorRecord = Record<NonVoidType, Record<NonVoidType, NonVoidType | TypeError>>
