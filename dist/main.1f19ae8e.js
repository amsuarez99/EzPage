...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../input.json":[function(require,module,exports) {
module.exports = [{
  "name": "h1",
  "config": {},
  "text": "This is an h1"
...
var _input = _interopRequireDefault(require("../../input.json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var data = _input.default;
console.log(data);
...
function mountVElement(vElement, parentDOMNode) {
  ...
  if (style !== undefined) {
    Object.keys(style).forEach(function (sKey) {
      return domNode.style[sKey] = style[sKey];
    });
  }
...
},{"../../input.json":"../../input.json"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
